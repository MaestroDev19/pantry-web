...
(()=>{
    const e = new Error("Cannot find module './shared/src/utils/hasA11yProp.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './shared/src/utils/mergeClasses.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
(()=>{
    const e = new Error("Cannot find module './shared/src/utils/toKebabCase.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './shared/src/utils/toPascalCase.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
//# sourceMappingURL=node_modules_lucide-react_dist_esm_bd5cfd7b._.js.map